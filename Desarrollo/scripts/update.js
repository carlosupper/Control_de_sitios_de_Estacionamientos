...
function update(id_parking,ocupados){
	...
	var url = "http://localhost/Control_de_sitios_de_Estacionamientos/Desarrollo/php/actualiza-estacionamiento.php?id_estacionamiento="+id_parking+"&ocupados="+ocupados;
...
var url1 = "http://localhost/Control_de_sitios_de_Estacionamientos/Desarrollo/php/consulta-estacionamiento-id.php?id_estacionamiento="+id_parking;
